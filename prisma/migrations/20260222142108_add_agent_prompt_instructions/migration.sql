...
INSERT INTO "new_app_settings" ("default_publisher_profile_id", "id", "max_publish_attempts", "scheduler_poll_interval_sec", "timezone") SELECT "default_publisher_profile_id", "id", "max_publish_attempts", "scheduler_poll_interval_sec", "timezone" FROM "app_settings";
